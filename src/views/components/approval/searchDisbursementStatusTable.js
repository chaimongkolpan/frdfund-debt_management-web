  ...
  const RenderData = (item, index) => {
    return (item && (
      <tr key={index}>
        ...
        <td>{item.petition_date_office ? stringToDateTh(item.petition_date_office, false, 'DD/MM/YYYY') : '-'}</td>
        <td>{item.disbursement}</td>
        <td>{toCurrency(item.petition_amount)}</td>
        <td>{item.petition_no_branch}</td>
        <td>{item.petition_date_branch ? stringToDateTh(item.petition_date_branch, false, 'DD/MM/YYYY') : '-'}</td>
        <td>{item.disbursement}</td>
        <td>{toCurrency(item.petition_amount)}</td>
