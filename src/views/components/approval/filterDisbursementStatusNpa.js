  ...
  const onSubmit = () => {
    if (handleSubmit) {
      handleSubmit({
        ...
        creditorType: "",
        creditor: "",
        DebtClassifyStatusList: ['อยู่ระหว่างการโอนเงินให้สาขา', 'โอนเงินให้สาขาแล้ว', 'อยู่ระหว่างการชำระหนี้แทน(สาขา)', 'อยู่ระหว่างการชำระหนี้แทน', 'ชำระหนี้แทนแล้ว','เตรียมการชำระหนี้แทน','เตรียมการชำระหนี้แทน(สาขา)'],
        ...filter,
        currentPage: 1,
