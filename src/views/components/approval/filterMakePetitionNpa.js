  ...
  const onSubmit = () => {
    if (handleSubmit) {
      handleSubmit({
        ...
        creditor: "",
        debtStatus: "",
        debtClassifyStatusList: ['ยืนยันยอดสำเร็จ','อยู่ระหว่างการชำระหนี้แทน','อยู่ระหว่างการโอนเงินให้สาขา','โอนเงินให้สาขาแล้ว','เตรียมการชำระหนี้แทน(สาขา)','ชำระหนี้แทนแล้ว','อยู่ระหว่างการชำระหนี้แทน(สาขา)'],
        ...filter,
        currentPage: 1,
