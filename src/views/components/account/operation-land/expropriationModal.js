                ...
                <div className="row g-3">
                    ...
                    { (showEdit || showDetail ) && (<> {/* start card แก้ไขรายละเอียดดำเนินการในที่ดิน */}
                        <div className="card shadow-none border my-2" data-component-card="data-component-card">
                            <div className="card-body p-0">
                                <div className="p-3 code-to-copy">
                                    <h3 className="text-center">{addTile ? 'เพิ่มการเวนคืน' : 'แก้ไขรายละเอียดการเวนคืน'}</h3><br />
                                    <div className="row g-2">
                                        ...
                                        <div className="col-sm-12 col-md-6 col-lg-6 mt-3 mb-1">
                                            <div className="d-flex justify-content-center">
                                                <span className='fw-bold'>อกสารประกอบสัญญาเวนคืน</span>
                                            </div>
                                            <br />
                                            <div className="col-12 mt-3 mb-3">
                                        ...
                                        <div className="card-body p-0">
                                            <div className="p-3 code-to-copy">
                                                ...
                                                <div className="row g-2 mt-1">
                                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-1">
                                                        <Textbox title={'เลขที่หนังสือยืมโฉนด'} containerClassname={'mb-3'} handleChange={(val) => setInstallment(val)} value={installment} disabled={isView} />
                                                    </div>
                                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-1">
...
<div className="col-sm-12 col-md-6 col-lg-6">
    <div className="form-floating form-floating-advance-select mb-3">
        <label htmlFor="floaTingLabelSingleSelect">หน่วยงานที่คืนเวนคืน</label>
        <select className={`form-select`} onChange={(e) => handleChangeDebt('debt_manage_status', e.target?.value)}>
            <option value="หน่วยงานภายนอก">หน่วยงานภายนอก</option>
            <option value="หน่วยงานรัฐ" >หน่วยงานรัฐ</option>
        </select>
...
<div className="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div className="row g-3 justify-content-center">
                            <div className="col-auto">
                                <button className="btn btn-outline-success me-1 mb-1 " type="button" onClick={handleAddReceiveRentForm}><span className="fas fa-plus fs-8"></span> เพิ่มรับเงินค่าเช่า</button>
                               
                            </div>
                        </div>
                    </div>
                  
                    {receiveRentForms.map((form, index) => (
                        < div key={form.id} className="mb-1 rounded p-3 position-relative">
                    <div className="card shadow-none border my-2" data-component-card="data-component-card">
                        <div className="card-body p-0">
                            <div className="p-3 code-to-copy">
                            <div className="d-flex justify-content-center mb-1">
                                <span className="text-center fw-bold">รับเงินค่าเวนคืนครั้งที่ {index+1}</span>
                            </div>
                                ...
                                <div className="row g-2 mb-1">
                                    ...
                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-4">
                                        <Textbox title={'เลขที่เช็ค'} containerClassname={'mb-3'} handleChange={(val) => setInstallment(val)} value={installment} disabled={isView} />
                                    </div>
                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-4">
                                        <DatePicker title={'วันที่เช็ค'} />
                                    </div>
                                ...
                                <div className="input-group mb-3">
                                                <span className="input-group-text" id="Search_id_card">เลขที่บัญชี</span>
                                                <input className="form-control" type="text" disabled={isView} aria-label="รายละเอียดน บ้าน" />
                                                <span className="input-group-text" id="Search_id_card">ชื่อบัญชี</span>
                                                <input className="form-control" type="text" disabled={isView} aria-label="รายละเอียดน บ้าน" />
                                                <span className="input-group-text" id="Search_id_card">ธนาคาร</span>
                                                <input className="form-control" type="text" disabled={isView} aria-label="รายละเอียดน บ้าน" />
                                            </div>
                                ...
                                <div className="row g-2">
                                    ...
                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-4">
                                        <Textbox title={'จำนวนเงินค่าเวนคืน'} containerClassname={'mb-3'} handleChange={(val) => setInstallment(val)} value={installment} disabled={isView} />
                                    </div>
                                    <div className="col-sm-12 col-md-6 col-lg-6 mb-4">
                    ...
                    <div className="d-flex justify-content-center mt-2 mb-2">
                            <button className="btn btn-phoenix-secondary btn-icon fs-7 text-success-dark px-0" type='button' onClick={() => handleAddReceiveRentForm(index + 1)}>
                                <i className="fas fa-square-plus"></i>
                            </button>
                            <button className="btn btn-phoenix-secondary btn-icon fs-7 text-danger-dark px-0" type='button' onClick={() => handleRemoveReceiveRentForm(form.id)}>
                                <i className="fas fa-square-minus"></i>
                            </button>
                        </div>
                        </ div>))}
