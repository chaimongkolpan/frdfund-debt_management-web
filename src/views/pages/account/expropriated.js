...
import Filter from "@views/components/account/operation-land/filterExpropriated";
import SearchTable from "@views/components/account/operation-land/searchTableExpropriated";
  ...
  return (
    <>
      <div className="content">
        <h4 className="mb-3">การเวนคืน</h4>
        <div className="mt-4">
