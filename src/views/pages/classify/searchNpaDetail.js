...
import DebtManageTable from "@views/components/classify/debtManageTableNpa";
...
import EditDetailModal from "@views/components/classify/editClassifyDetailNpaModal";
  ...
  return (
    <>
      <div className="content">
        <h4 className="mb-3">จำแนกมูลหนี้ NPA</h4>
        <div className="mt-4">
...
export default SearchClassifyNPADetail;