...
const SearchClassifyNPA = () => {
  ...
  const viewDetail = async (debt) => {
    ...
    window.open(`${process.env.VITE_.BASE_URL ?? ''}/classify/searchNPA/detail/${debt.idCard}?province=${debt.province}&creditor-type=${debt.creditorType}`, '_blank', 'noopener,noreferrer');
  }
