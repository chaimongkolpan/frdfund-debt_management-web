...
import Filter from "@views/components/approval/filterAdditionalNpa";
import SearchTable from "@views/components/approval/searchAdditionalTableNpa";
import { 
  cleanData,
  ...
  return (
    <>
      <div className="content">
        <h4>การดำเนินการเพิ่มเติม NPA</h4>
        <div>
