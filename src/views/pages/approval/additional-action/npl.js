...
import Filter from "@views/components/approval/filterAdditional";
import SearchTable from "@views/components/approval/searchAdditionalTable";
import { 
  cleanData,
  ...
  return (
    <>
      <div className="content">
        <h4>การดำเนินการเพิ่มเติม NPL</h4>
        <div>
