...
import { 
  ...
  searchConfirmCommitteePrepareAddedNpa,
  addConfirmCommitteePrepareNpa,
  removeConfirmCommitteePrepareNpa,
...
const NPA = () => {
  ...
  const fetchData = async (query) => {
    ...
    const result = await searchConfirmCommitteePrepareAddedNpa(query);
    if (result.isSuccess) {
      setAddedData(result);
    } else {
      setAddedData(null);
